...
export const SERVICES: Service[] = [
  ...
  },
  {
    id: 'half_turf_60',
    label: 'Turf – 60 min',
    description: "The 60'×50' turf field for small group training or practice.",
    priceCents: 7500,
  ...
  },
  {
    id: 'team_standard_60',
    label: 'Team Standard',
    description: "The 60'×50' turf field (open field) + 2 batting cages. Ideal for organized practices, skill work, and small team training.",
    priceCents: 15000,
  ...
  },
  {
    ...
    description: "The 60'×50' turf field plus 2 batting cages for an extended team practice.",
  ...
  },
  {
    ...
    description: "The 60'×50' turf field plus 2 batting cages for a full two-hour practice.",
  ...
  },
  {
    ...
    description: "Exclusive use of all 4 cages and the entire turf field for 90 minutes.",
  ...
  },
  {
    ...
    description: "Exclusive use of all 4 cages and the entire turf field for two hours.",
