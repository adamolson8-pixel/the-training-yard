      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-8 max-w-md w-full relative">
        ...
        <form @submit.prevent="submitUser" class="space-y-4">
          ...
          <div>
            ...
            <input type="password" v-model="addForm.password" required class="w-full border border-gray-200 rounded-xl px-4 py-2 text-gray-900 focus:ring-primary focus:border-primary">
          </div>
          <div>
