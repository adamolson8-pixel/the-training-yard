<template>
  <div class="bg-dark-card border-b border-white/5 py-2 relative z-50">
    <div class="section-container">
      <div class="flex items-center justify-between text-sm">
        ...
        <div class="hidden md:flex items-center gap-6 text-gray-400">
          <a
            id="utility-address"
            href="https://maps.google.com/?q=2519+NW+66th+Ave+Des+Moines+IA+50313"
            target="_blank"
          ...
          >
            ...
            <span>2519 NW 66th Ave, Des Moines, IA 50313</span>
          </a>
        ...
        <div class="flex items-center gap-4 ml-auto">
          ...
          >
            ...
            <span class="hidden sm:inline">515.441.0528</span>
          </a>
          <template v-if="user">
            <NuxtLink
              to="/portal/dashboard"
